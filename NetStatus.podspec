...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Abdallah Eid" => "abdallah.eid@vezeeta.com" }
  # Or just: spec.author    = "Abdallah Eid"
  # spec.authors            = { "Abdallah Eid" => "abdallah.eid@vezeeta.com" }
  # spec.social_media_url   = "https://twitter.com/Abdallah Eid"
  ...
  spec.source       = { :git => "https://github.com/abdallahEid/NetStatus.git", :tag => "#{spec.version}" }
